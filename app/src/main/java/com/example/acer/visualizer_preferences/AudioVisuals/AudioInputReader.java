package com.example.acer.visualizer_preferences.AudioVisuals;
...
import com.example.acer.visualizer_preferences.R;
...
public class AudioInputReader {
    ...
    private void initVisualizer() {
        // Setup media player
        mPlayer = MediaPlayer.create(mContext, R.raw.dilbar);
